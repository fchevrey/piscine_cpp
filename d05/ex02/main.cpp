...
/*   Updated: 2019/04/01 21:04:38 by fchevrey         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
	Form			*presform = new PresidentialPardonForm("H2G2");
	Form			*robotform = new RobotomyRequestForm("John");
	Form			*terra = new ShrubberyCreationForm("Terra");
